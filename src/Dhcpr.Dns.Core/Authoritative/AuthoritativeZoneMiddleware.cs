...
/// <summary>
/// Answers from loaded authoritative zones (AA / NODATA / NXDOMAIN) and follows
/// in-zone NS cuts, preferring a loaded child zone at the cut when present.
/// </summary>
public sealed class AuthoritativeZoneMiddleware : IDomainMessageMiddleware
{
    ...
    public AuthoritativeZoneMiddleware(
    ...
    // After DynDNS (200), before forward (500) / recursive (5000).
